...
<body>
    ...
    // 現在の店舗IDを取得
    var currentShopId = parseInt($("#shop_id").val());

    // 次の店舗IDを計算
    var nextShopId = currentShopId + 1;

    // 新しいURLに遷移
    window.location.href = "/detail/" + nextShopId;
}
...
function showPreviousShop() {
    ...
    // 前の店舗IDを計算
    var previousShopId = currentShopId - 1;

    // 新しいURLに遷移
    window.location.href = "/detail/" + previousShopId;
}
